...
class _HomeState extends State<Home> {
  ...
  @override
  void initState() {
    Provider.of<NetworkWordPress>(context, listen: false).getPosts();
  ...
  Widget build(BuildContext context) {
    final listofWordPressPost = Provider.of<NetworkWordPress>(context).list;
    print('This is the Network Provider Post $listofWordPressPost');
    return Scaffold(
      // backgroundColor: Colors.green.shade900,

      // drawer: Drawer(child: MainDrawer()),

      body: (listofWordPressPost == null)
          ? Center(
              child: Container(
                  height: 60,
                  width: 80,
          ...
          : RefreshIndicator(
              ...
              onRefresh: () async {
                await Provider.of<NetworkWordPress>(context, listen: false)
                    .getPosts();
                setState(() {});
              },
              child: Scrollbar(
